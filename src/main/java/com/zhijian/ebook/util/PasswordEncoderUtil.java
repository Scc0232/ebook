...
public class PasswordEncoderUtil {
	...
	public static void main(String[] args) {
		String salt = "123456";
		PasswordEncoderUtil encoderMd5 = new PasswordEncoderUtil(salt, "MD5");
		String encode = encoderMd5.encode("ouyang");
		System.out.println(encode);
		
		boolean passwordValid = encoderMd5.isPasswordValid("beb3b5b558d5731d313232dc4a8bd976", "ouyang");
		System.out.println(passwordValid);

		PasswordEncoderUtil encoderSha = new PasswordEncoderUtil(salt, "MD5");
