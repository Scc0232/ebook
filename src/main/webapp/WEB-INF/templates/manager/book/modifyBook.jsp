...
<form id="book-fm" method="post" enctype="multipart/form-data" action="${basePath}manager/book/modifyBook.do">
	...
	<div class="fitem" style="margin-top: 20px;">
		<label align="right">ISBN：</label> <input name="isbn" validtype="length[5,20]" missingMessage="不能为空" invalidMessage="有效长度5-20"
			value="${book.isbn}" class="easyui-textbox" required="true" style="width: 180px; height: 26px;"> <label style="margin-left: 20px"
			align="right">书名：</label> <input name="title" class="easyui-textbox" required="true" style="width: 180px; height: 26px;"
			value="${book.title}">
	</div>
	<div class="fitem" style="margin-top: 20px;">
		<label align="right">子标题：</label> <input name="subtitle" class="easyui-textbox" style="width: 180px; height: 26px;"
			value="${book.subtitle}"> <label style="margin-left: 20px" align="right">作者 ：</label> <input name="author" class="easyui-textbox"
			style="width: 180px; height: 26px;" value="${book.author}">
	</div>
	<div class="fitem" style="margin-top: 20px;">
		<label align="right">出版社 :</label> <input name="publisher" class="easyui-textbox" style="width: 180px; height: 26px;"
			value="${book.publisher}"> <label style="margin-left: 20px" align="right">页数 :</label> <input name="page" class="easyui-textbox"
			style="width: 180px; height: 26px;" value="${book.page}">
	</div>
	<div class="fitem" style="margin-top: 20px;">
		<label align="right">折旧价格 :</label> <input name="depPrice" class="easyui-textbox" style="width: 180px; height: 26px;"
			value="${book.depPrice}"> <label style="margin-left: 20px" align="right">押金 :</label> <input name="deposit" maxlength='100'
			class="easyui-textbox" style="width: 180px; height: 26px;" value="${book.deposit}">
	</div>
	<div class="fitem" style="margin-top: 20px;">
		<label align="right">e币价格 :</label> <input name="ePrice" class="easyui-textbox" style="width: 180px; height: 26px;" value="${book.ePrice}">
		<label style="margin-left: 20px" align="right">分类名称 :</label> <select id="classidCombobox" class="easyui-combobox" name="classId"
			style="width: 180px;" editable="false" panelHeight="auto" value="${book.classId}">
	...
	<div class="fitem" style="margin-top: 20px;">
		<label align="right">学校 :</label> <input id="college" name="college" class="easyui-combobox" style="width: 180px; height: 26px;"
			value="${book.college}" onvaluechanged="onCollegeChanged"> <label style="margin-left: 20px" align="right">学院 :</label> <input id="academy" name="academy"
			maxlength='100' class="easyui-textbox" style="width: 180px; height: 26px;" value="${book.academy}" onvaluechanged="onacademyChanged">
	</div>
	<div class="fitem" style="margin-top: 20px;">
		<label align="right">专业 :</label> <input id="profession" name="profession" maxlength='100' class="easyui-combobox"
			style="width: 180px; height: 26px;" value="${book.profession}"> <label style="margin-left: 20px" align="right">年级 :</label> <input
			name="grade" maxlength='100' class="easyui-textbox" style="width: 180px; height: 26px;" value="${book.grade}">
	</div>
	<div class="fitem" style="margin-top: 20px;">
		<label align="right">原价 :</label> <input name="initCost" class="easyui-textbox" style="width: 180px; height: 26px;"
			value="${book.initCost}"> <label style="margin-left: 20px" align="right">其他平台 :</label> <input name="otherCost" maxlength='100'
			class="easyui-textbox" style="width: 180px; height: 26px;" value="${book.otherCost}">
	</div>
	<div class="fitem" style="margin-top: 20px;">
		<label align="right">节省 :</label> <input name="saveCose" maxlength='100' class="easyui-textbox" style="width: 180px; height: 26px;"
			value="${book.saveCose}"> <label style="margin-left: 20px" align="right">图片URL : </label> <input id="icons" name="icons"
			maxlength='200' class="easyui-filebox" style="width: 180px; height: 26px;" value="${book.icon}">
	</div>
</form>
