...
$(function(){
	...
	$("#industryAdd-saveBtn").click(function(){
		 $("#industry-fm").form('submit', { 
			 url : '${basePath}industry/addIndustry.do', 
			 onSubmit : function() {
            loading();
...
<form id="industry-fm" method="post" novalidate>
	<table class="am_table_1">
		...
		<tr>
			<th>行业名称 ：</th>
			<td><input name="sectorName" class="easyui-textbox" required="true"
				style="width: 180px; height: 26px;"></td>
		</tr>
			<th>父行业 ：</th>
			<td>
				<input id="fatherSectorid" name="fatherSectorId" class="easyui-textbox"
...
<p align="center">
	<a id="industryAdd-saveBtn" class="easyui-linkbutton"><font size="3">提&nbsp;&nbsp;交</font></a>
</p>